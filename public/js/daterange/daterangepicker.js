  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function() {
            ...
            if (this.element.children() && this.element.children().is("input") && !this.singleDatePicker) {
                this.element.children().val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
