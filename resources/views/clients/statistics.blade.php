    ...
    <div class="panel-body profile-information">
       <div class="col-md-12">
           <div class="profile-desk">
               <h1>{{ $p_Client['name'] }}</h1>
               <input id="p_ID" type="hidden" value="{{ $p_Client['id'] }}"/>
           </div>
       </div>
    </div>
    <div class="adv-table">
...
//                        '<option value="check-out">Check-out</option>' +
            ...
            @else
            if (v_Index === 0) {
                $(this).html( '<div class="date pull-right" id="daterangepicker2">' +
                '<input class="form-control dateInput" type="text"#footer{ id="dateRange2" placeholder="Buscar">' +
                '</div>' );
            }
            else if (v_Index === 1) {
                $(this).html(
...
//                    '<option value="check-out">Check-out</option>' +
        ...
        var v_Table = $('#dynamic-table').DataTable(
        {
            ...
            ajax:
            {
                ...
                data: { "p_ClientID" : $('#p_ID').val(), "p_CompanyID" : null }
            },
            "orderCellsTop": true,
